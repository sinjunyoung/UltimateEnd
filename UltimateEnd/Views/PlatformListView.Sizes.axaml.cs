...
namespace UltimateEnd.Views
{
    public partial class PlatformListView
    {
        ...
        public static readonly StyledProperty<Thickness> VersionMarginProperty = AvaloniaProperty.Register<PlatformListView, Thickness>(nameof(ClockMargin), new Thickness(20, 0, 0, 10));
