...
namespace UltimateEnd.Services
{
    public class DialogService
    {
        ...
        public void RegisterLoadingOverlay(Func<string, CancellationTokenSource?, Task> showLoading, Func<Task> hideLoading)
        {
        ...
        public Task ShowMessage(string title, string message, MessageType type = MessageType.Info)
        {
            if (_showMessage == null)
                throw new InvalidOperationException("MessageOverlay가 등록되지 않았습니다.");
        ...
        public Task<bool> ShowConfirm(string title, string message)
        {
            if (_showConfirm == null)
                throw new InvalidOperationException("ConfirmOverlay가 등록되지 않았습니다.");
        ...
        {
            if (_showThreeButton == null)
                throw new InvalidOperationException("ThreeButtonOverlay가 등록되지 않았습니다.");
        ...
        public Task ShowLoading(string message = "로딩 중...", CancellationTokenSource? cts = null)
        {
            if (_showLoading == null)
                throw new InvalidOperationException("LoadingOverlay가 등록되지 않았습니다.");
