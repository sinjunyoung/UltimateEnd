...
namespace UltimateEnd.Services
{
    public sealed class PlatformInfoService
    {
        ...
        private static PlatformDatabase CreateDefaultDatabase()
        {
            ...
            db.Platforms.Add(new PlatformInfo { Id = "3ds", DisplayName = "Nintendo 3DS", Aliases = ["nintendo3ds"], Extensions = [".3ds", ".3dsx", ".app", ".cia", ".axf", ".cci", ".cxi"], ScreenScraperSystemId = ScreenScraperSystemId.Nintendo3DS });
