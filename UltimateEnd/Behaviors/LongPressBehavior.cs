...
namespace UltimateEnd.Behaviors
{
    public static class LongPressBehavior
    {
        ...
        private static void OnPointerPressed(object? sender, PointerPressedEventArgs e)
        {
            ...
            state.Timer = new DispatcherTimer { Interval = TimeSpan.FromMilliseconds(GetDuration(element)) };
        ...
        private static void TimerTick(object? sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(methodName) && target != null)
            {
                try
                {
                    var method = target.GetType().GetMethod(methodName, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
                    var dataContext = (element as IDataContextProvider)?.DataContext;
